...
const Work = () => {
	...
	return (
		<motion.section
			...
			className="min-h-[100vh] flex justify-center items-center lg:px-0"
		>
							...
							<div className="flex items-center gap-4">
									...
									<TooltipProvider delayDuration={100}>
										<Tooltip>
											<TooltipTrigger className="w-[70px] h-[70px] rounded-full bg-primary/5 flex justify-center items-center group">
												<BsArrowUpRight className="text-foreground text-3xl group-hover:text-accent"></BsArrowUpRight>
											</TooltipTrigger>
											<TooltipContent>
												<p>live project</p>
											</TooltipContent>
								...
								<Link href={project.github}>
									<TooltipProvider delayDuration={100}>
										<Tooltip>
											<TooltipTrigger className="w-[70px] h-[70px] rounded-full bg-primary/5 flex justify-center items-center group">
												<BsGithub className="text-foreground text-3xl group-hover:text-accent"></BsGithub>
											</TooltipTrigger>
											<TooltipContent>
							...
							{projects.map((project, index) => {
								return (
									<SwiperSlide key={index} className="w-full">
										<div className="h-115 relative group flex justify-center items-center bg-secondary/30 backdrop-blur-md border border-white/10 rounded-xl overflow-hidden">
											{/* overlay */}
											<div className="absolute top-0 bottom-0 w-full hover:bg-foreground/10 z-10"></div>
											{/* image */}
